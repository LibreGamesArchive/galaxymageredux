...
mapd.make_entity('test-ent1.gif', (0.5,0.5), 'Bob')
mapd.make_entity('test-ent1.gif', (1.5,0.5), 'Bob')
mapd.make_entity('test-ent1.gif', (0.5,1.5), 'Bob')
mapd.make_entity('test-ent1.gif', (1.5,1.5), 'Bob')
